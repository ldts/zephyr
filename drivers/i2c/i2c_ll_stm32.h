...
s32_t msg_write(struct device*, struct i2c_msg*, u32_t, u16_t);
s32_t msg_read(struct device*, struct i2c_msg*, u32_t, u16_t);
s32_t i2c_configure_timing(struct device*, u32_t);
void i2c_stm32_ev_isr(void*);
void i2c_stm32_er_isr(void*);
#endif	/* _STM32_I2C_H_ */
